			...
			<form onSubmit={handlerSubmit} className={s.form}>
				...
				<div className={s.input_block}>
					...
					<Input
						...
						placeholder="John"
						autoComplete="off"
						className={`${s.input} ${firstName.state ? "" : s.error}`}
						onChange={(event) =>
							setFirstName((prev) => ({ ...prev, name: event.target.value }))
						}></Input>
				...
				<div className={s.input_block}>
					...
					<Input
						...
						placeholder="Brown"
						autoComplete="off"
						className={`${s.input} ${lastName.state ? "" : s.error}`}
						onChange={(event) =>
							setLastName((prev) => ({ ...prev, name: event.target.value }))
						}></Input>
				...
				<div className={s.input_block}>
					...
					<Input
						...
						onChange={(event) =>
							setEmail((prev) => ({ ...prev, mail: event.target.value }))
						}></Input>
				...
				<div className={s.input_block}>
					...
					<Input
						...
						autoComplete="off"
						className={`${s.input} ${specialization.state ? "" : s.error}`}
						onChange={(event) =>
							setSpecialization((prev) => ({
								...prev,
				...
				<div className={s.input_block}>
					...
					<Input
						...
						autoComplete="off"
						className={`${s.input} ${password.state ? "" : s.error}`}
						onChange={(event) =>
							setPassword((prev) => ({ ...prev, pswd: event.target.value }))
						}></Input>
				...
				<div className={s.input_block}>
					...
					<Input
						...
						autoComplete="off"
						className={`${s.input} ${repeatPassword.state ? "" : s.error}`}
						onChange={(event) =>
							setRepeatPassword((prev) => ({
								...prev,
